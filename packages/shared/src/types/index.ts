...
export type SectionCardType = 'hero_slider' | 'testimonials' | 'facilities_preview' | 'leadership' | 'legacy_timeline' | 'why_choose_us' | 'activities' | 'annual_events' | 'campus_facilities';
