...
<svg xmlns="http://www.w3.org/2000/svg" width="72" height="86" viewBox="0 0 72 86">
  <defs>
    ...
    <linearGradient id="sideGrad" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#243358"/>
  ...
  <rect x="32" y="50" width="8" height="18" fill="none" stroke="#0A1628" stroke-width="0.6"/>
  <circle cx="38" cy="59" r="0.7" fill="#0A1628"/>
  <!-- windows -->
  <rect x="19" y="40" width="7" height="6" fill="#D4A843"/>
  <rect x="19" y="40" width="7" height="6" fill="none" stroke="#0A1628" stroke-width="0.4"/>
  <rect x="46" y="40" width="7" height="6" fill="#D4A843"/>
  <rect x="46" y="40" width="7" height="6" fill="none" stroke="#0A1628" stroke-width="0.4"/>
  <!-- flag pole + flag -->
  ...
  <!-- name plate -->
  <rect x="4" y="68" width="64" height="12" rx="3" fill="#0A1628" stroke="#D4A843" stroke-width="1"/>
