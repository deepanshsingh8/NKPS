        ...
        <div className="mx-auto max-w-3xl text-center">
          <AnimatedSection>
            ...
            <p className="mt-6 text-base md:text-lg leading-relaxed text-gray-700">
              For over four decades, NK Public School has nurtured students who
              have gone on to make their mark across the world — in medicine,
              engineering, civil services, business, sports and the arts. Our
              alumni are our proudest achievement, and their stories continue to
              inspire the students of today. We&apos;re building a vibrant alumni
              network to stay connected, give back, and celebrate every milestone
              together.
            </p>
          </AnimatedSection>
        </div>
            ...
            >
              {alumni.map((person) => (
                <motion.div
                  key={person.id}
                  variants={fadeUp}
                  className="group flex flex-col overflow-hidden rounded-3xl bg-white border border-gray-100 shadow-lg shadow-black/5 transition-shadow duration-500 hover:shadow-2xl hover:shadow-black/10"
                >
                  {/* Photo / initials */}
