...
export const ADMISSIONS_FAQS = [
  {
    ...
    a: "Admissions for the new academic session typically open in January. For exact dates and forms, please call the school office or visit the campus on Grand Sikar Road, Rajawas, Jaipur.",
  },
  {
