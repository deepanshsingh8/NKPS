...
const tiles: ExamTile[] = [
  ...
  },
  {
    ...
    href: "/erp/exams/non-scholastic-masters",
    icon: Sparkles,
  ...
  },
  {
    ...
    href: "/erp/exams/blank-marks-list",
    icon: FileText,
