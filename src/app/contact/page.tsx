...
const faqs = [
  {
    question: "How to reach the school?",
    answer:
      "The school is located on Grand Sikar Road, Rajawas. It is easily accessible by public transport and private vehicles.",
  },
  {
    question: "What documents are needed for admission?",
    answer:
      "Please bring: Birth Certificate, Previous School Records, Transfer Certificate, Passport-size photographs, and Aadhaar Card copy.",
  },
  {
    question: "Is transport available?",
    answer:
      "Yes, we provide transport services covering major routes across Jaipur city.",
  },
  {
    question: "What are the school timings?",
    answer: "School operates Monday to Saturday, 8:00 AM to 2:30 PM.",
  },
];
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-6xl">
          <AnimatedSection>
            <SectionHeading
              title="Find Us"
              subtitle="Visit our campus on Grand Sikar Road, Rajawas"
            />
          </AnimatedSection>
          ...
          <AnimatedSection delay={0.2}>
            <div className="mt-12 overflow-hidden rounded-2xl border border-gray-200 shadow-xl">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3556.2!2d75.78!3d26.95!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjbCsDU3JzAwLjAiTiA3NcKwNDYnNDguMCJF!5e0!3m2!1sen!2sin!4v1"
                width="100%"
                height="400"
                style={{ border: 0 }}
                allowFullScreen
